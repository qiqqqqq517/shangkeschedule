...
![Version](https://img.shields.io/badge/version-3.8.1-blueviolet)
...
> 以下为真实运行截图（v3.8.1），覆盖三种主题样式与主要功能页。
...
- **1783 所高校清单** + **7 类通用教务适配器**（正方、URP、青果、强智、金智、南软、超星等）。
- 另有 **136 个院校专属适配脚本**，适配特殊教务页面与登录流程（如湖北工程学院 ehall 办事大厅、武汉纺织大学外经贸学院强制桌面版等）。
