...
async function fetchAndParseCourses(academicYear, semesterIndex) {
    ...
    window.shangkeBridge.showToast("正在通过API获取课表数据...");
    ...
    try {
        ...
        window.shangkeBridge.showToast("API 返回数据异常，请检查登录状态或学年学期选择。");
        return null;
    } catch (e) {
        console.error("API fetch error: " + e.message);
        window.shangkeBridge.showToast("请求课表数据失败，请确认已登录教务系统。");
        return null;
    }
}
