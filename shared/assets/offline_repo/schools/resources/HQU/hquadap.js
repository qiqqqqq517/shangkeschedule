...
async function runImportFlow() {
    window.shangkeBridge.showToast("正在启动华大教务同步程序...");
    ...
    return {
        ...
        window.shangkeBridge.showToast(`${currentXNXQ} 导入成功！`);
        window.shangkeBridge.notifyTaskCompletion();

    } catch (e) {
        await window.shangkeBridgePromise.showAlert("导入失败", "错误: " + e.message, "重试");
    }
}
