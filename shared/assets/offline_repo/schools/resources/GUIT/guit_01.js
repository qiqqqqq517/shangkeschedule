...
async function saveTimeSlots() {
    await window.shangkeBridgePromise.savePresetTimeSlots(JSON.stringify(PRIMARY_TIME_SLOTS));
}
...
async function runImportFlow() {
    try {
        ...
        if (typeof window.shangkeBridge !== "undefined" && window.shangkeBridge.notifyTaskCompletion) {
