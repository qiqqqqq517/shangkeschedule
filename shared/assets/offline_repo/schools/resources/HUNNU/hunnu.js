...
async function runImportFlow() {
    window.shangkeBridge.showToast("湖南师范大学课程导入启动...");
    ...
    if (!confirmed) { window.shangkeBridge.showToast("导入已取消"); return; }
    ...
    try {
        ...
        window.shangkeBridge.showToast("导入时间段失败: " + e.message);
    }
    ...
    try {
        ...
        window.shangkeBridge.showToast("保存课程数据失败: " + e.message);
        return;
    }
