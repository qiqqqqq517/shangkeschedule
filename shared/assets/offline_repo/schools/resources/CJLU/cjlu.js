...
async function fetchAndParseCourses(academicYear, semesterIndex) {
    ...
    window.shangkeBridge.showToast("未能获取课表数据，请检查登录状态或学年学期。");
...
async function runImportFlow() {
    ...
    if (!isOnCjluJwxt()) {
        ...
        window.shangkeBridge.showToast("请先进入中国计量大学教务系统。");
        await window.shangkeBridgePromise.showAlert("导入失败", msg, "确定");
        return;
    }
