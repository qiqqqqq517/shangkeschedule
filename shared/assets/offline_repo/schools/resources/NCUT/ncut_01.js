(function() {
    ...
    async function saveCourses(c){ try{await window.shangkeBridgePromise.saveImportedCourses(JSON.stringify(c));}catch(e){} }
    async function saveTimeSlots(s){ try{await window.shangkeBridgePromise.savePresetTimeSlots(JSON.stringify(s));}catch(e){} }
    async function saveConfig(c){ try{await window.shangkeBridgePromise.saveCourseConfig(JSON.stringify(c));}catch(e){} }
