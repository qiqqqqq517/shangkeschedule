...
async function runImportFlow() {
    try {
        ...
        const campusIdx = await window.shangkeBridgePromise.showSingleSelection(
            "请选择您所在的校区",
        ...
        // 保存
        await window.shangkeBridgePromise.saveCourseConfig(JSON.stringify(getCourseConfig()));
        ...
        window.shangkeBridge.showToast(`成功导入 ${courses.length} 节课程（${selectedCampus}作息）！`);
