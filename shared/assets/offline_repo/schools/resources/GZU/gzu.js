// 贵州大学 (gzu.edu.cn) 拾光课程表适配脚本
// 基于正方教务系统 v9.2 接口适配

/**
 * 解析周次字符串，处理单双周和周次范围。
 * 格式: "1-16周", "1-15周(单)", "2-16周(双)", "8周"
 */
...
async function fetchAndParseCourses(academicYear, semesterIndex) {
    ...
    window.shangkeBridge.showToast("未能获取课表数据，请检查是否已登录并进入课表页面。");
    return null;
}
...
const TimeSlots = [
    ...
    { number: 11, startTime: "21:30", endTime: "22:20" }
];
