...
data class Course(
    ...
    val credit: String? = null, // 课程学分，如 "3"、"2.5"
    val assessmentMethod: String? = null, // 考核方式，如 "考试"、"考查"
    @ColumnInfo(defaultValue = "0")
    val isLab: Boolean = false, // 是否为实验课

    @ColumnInfo(defaultValue = "0")
    val isCrush: Boolean = false // 是否为 crush（情侣）课表课程，仅用于展示，禁止编辑
)