...
private val CloudGridStyle = ScheduleGridStyle(
    ...
    sectionHeightDp = 72f,
    courseBlockCornerRadiusDp = 16f,
    courseBlockOuterPaddingDp = 4f,
    courseBlockInnerPaddingDp = 12f,
...
private val CleanGridStyle = ScheduleGridStyle(
    ...
    sectionHeightDp = 58f,
    courseBlockCornerRadiusDp = 6f,
    courseBlockOuterPaddingDp = 2f,
    courseBlockInnerPaddingDp = 4f,
    courseBlockAlphaFloat = 1f,
    courseColorMaps = listOf(
